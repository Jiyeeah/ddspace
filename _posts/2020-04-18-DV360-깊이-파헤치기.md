...
CM과 DV360이 하는 역할에 다소 중첩되는 면이 많다보니, 처음 GMP를 접했을 때 가장 헷갈리는 부분이 CM과 DV360의 차이점이다. 실제로 구글은 CM의 역할을 점차 DV360으로 넘겨가는 계획을 갖고 있기도 하다. 하지만 일단은 두 개의 플랫폼이 존재하고, 함께 활용되고 있다. 이런 상황에서 각각의 역할을 이해하고 함께 활용하는 것은 중요하니까, 한마디로 역할을 정리해본다면 아래와 같다. 
